...
use app\modules\purchase\controllers\MyPurchaseController;
use Yii;
use yii\base\Model;
 ...
 */
class ApprovePurchaseDetailSearch extends PurchaseDetail
{
    public $query;
    ...
    public function search($params)
    {
     /*   $s = $_SERVER['QUERY_STRING'];
       //用 parse_str 解析
        parse_str($s, $a);*/
        $query = $this->query ? $this->query : PurchaseDetail::find()->where(
            ['status'=>'NA']
        );;
