...
<div class="category-index">
    ...
    <?=Html::a('<span class="btn btn-success fa fa-plus">添加采购目录</span>', ['create-m'], ['title' => '添加'] );?>
    <button class="btn btn-success fa fa-plus" onclick="createNode()">添加子目录</button>
        ...
        if (data.save) {
            if (data.isNew) {
                $.ajax({
                    ...
                    type: "POST",
                    data: {
                        parentCode: data.node.parent.key,
